...
// on its schema unit annotation ("metrique.unit").

const { formatHumanDuration, formatHumanBytes, formatFieldValue } = require("./format.js");
...
assertEq(formatHumanBytes(12_884_901_888), "12.00 GiB", "12 GiB RSS from issue #472");
...
assertEq(formatFieldValue(12_884_901_888n, "bytes"), "12.00 GiB", "BigInt bytes");
