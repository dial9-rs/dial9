// Typed seam over the frozen trace_scope.js scope codec: it maps a heatmap /
...
// positional key parser so a scope built here matches viewer.html /
// flamegraph.html and the Node oracle (test_trace_scope.js) exactly.
//
